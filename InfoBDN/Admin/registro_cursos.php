...
<body>
    ...
    if(isset($_SESSION['admin'])){
        ...
        if(isset($_POST['nombre'])){
            ...
            /*$sql = "INSERT INTO cursos (`codigo`,`nombre`,`descripcion`,`horas`,`fecha inicio`,`fecha final`, `profesor`) VALUES (NULL,'".$_POST['nombre']."','".$_POST['descripcion']."',".$_POST['horas'].",'".$_POST['fecha_inicio']."','".$_POST['fecha_final']."','".$_POST['profesor']."')";
            if($resultado = $con->query($sql)){
