...
<body>
    ...
    if(isset($_SESSION['array_profesor'])){
        ...
        $profesor_cursos = profesor_cursos_finalizados($con,$_SESSION['array_profesor']['dni']);
        ...
        foreach($profesor_cursos as $clave => $valor){
            echo "<div class='curso'>";
                ...
                echo "<div class='contenido'>";
                    ...
                    echo "<a class='boton_curso' href='profesor_curso.php?curso=".$valor['codigo']."'>Evaluar</a>";
                echo "</div>";
            echo "</div>";
        }
    }else{
